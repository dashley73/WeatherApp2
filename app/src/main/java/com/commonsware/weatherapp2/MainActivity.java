...
//import com.commonsware.youtubeweatherapp.CurrentWeatherService.CurrentWeatherCallback;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationField.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                fab.setImageResource(count == 0 ? R.drawable.ic_refresh_black_24dp : R.drawable.ic_search_black_24dp);
                textCount = count;
    ...
    private final CurrentWeatherService.CurrentWeatherCallback currentWeatherCallback = new CurrentWeatherService.CurrentWeatherCallback() {
        ...
        public void onError(@Nullable Exception exception) {
            toggleProgress(false);
            fetchingWeather = false;
            Toast.makeText(MainActivity.this, "There was an error fetching weather, try again.", Toast.LENGTH_SHORT).show();
